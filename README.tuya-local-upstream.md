# Tuya Local — general documentation (upstream)

This is the standard [make-all/tuya-local](https://github.com/make-all/tuya-local) readme, kept here for reference. **Inkbird ISC-028-BW owners:** start with [README.md](README.md) on branch `inkbird-isc028bw`.
